...
let getPollsForGroup = require('../../utils/query-polls');
...
let GroupViewLatest = React.createClass({
  mixins: [ParseReact.Mixin],

  observe: function(props, state) {
    console.log(props.route.groupObject)
    return {
      groupThoughts: new Parse.Query('Poll').equalTo('groups', props.route.groupObject.objectId).descending('updatedAt')
    };
  },
    ...
    return (
      <View style={styles.fullScreen}>
        <NavigationBar
          tintColor={'white'}
          title={{
            title: this.props.route.groupObject.groupName,
            tintColor: '#008299'
          }}
          leftButton={
            <LeftButton
...
module.exports = GroupViewLatest;
